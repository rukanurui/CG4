...
const std::string defaultTextureFileName = "white1x1.png";
...
FbxModel* FbxLoader::LoadModelFromFile(const string& modelName)
{
    ...
    ParseNodeRecursive(fbxmodel, fbxScece->GetRootNode());
    //fbxシーン解放
    fbxmodel->fbxScene = fbxScece;
...
void FbxLoader::ParseNodeRecursive(FbxModel* model, FbxNode* fbxNode, Node* parent = nullptr)
{
    //ノード名を取得
